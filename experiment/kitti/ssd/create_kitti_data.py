...
if __name__ == "__main__":
    ...
    root_dir = '/home/vis/heming/data/KITTI_detection/training/image_2/'
    list_file = '/home/vis/heming/data/KITTI_detection/training/Annotations-3cls/{}.txt'.format(dataset)
    out_dir = '/home/vis/heming/data/KITTI_detection/training/lmdb/kitti_{}_lmdb'.format(dataset)
    example_dir = 'examples/KITTI'

    #need_name_size = 1 #True
    name_size_file = 'data/KITTI/{}_name_size.txt'.format(dataset)
