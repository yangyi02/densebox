...
train_data = "examples/{}/{}_train_lmdb".format(dataset, dataset.lower())
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "examples/{}/{}_test_lmdb".format(dataset, dataset.lower())
...
save_dir = "models/InceptionNet/{}/{}".format(dataset, job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/InceptionNet/{}/{}".format(dataset, job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/InceptionNet/{}/{}".format(dataset, job_name)
...
pretrain_model = "models/InceptionNet/Inception_ILSVRC_16_layers_fc_reduced.caffemodel"
# Stores LabelMapItem.
...
# conv8_2 ==> 3 x 3
# pool6 ==> 1 x 1
mbox_source_layers = ['mixed_2/join', 'mixed_7/join', 'mixed_10/join', 'conv6_2', 'conv7_2', 'pool6']
# in percent %
min_ratio = 20
max_ratio = 95
